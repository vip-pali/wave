			...
			<div id="content" class="col-lg-12 col-sm-12">
				...
				<div class="row">
					<div class="box col-md-12">
							...
							<a
								...
								<a
									...
									color="#324C6E" style="font-size: 14px; font-weight: normal">Create
										Center</font></a>&nbsp;&nbsp;|
							   <a
									href='<s:url value="/gotoCreateUserCredential"><s:param name="actionType" >2</s:param></s:url>'><font
									color="#324C6E" style="font-size: 14px; font-weight: normal">Create
						...
						<div class="pull-left">
							&nbsp;&nbsp;<strong>Create User Credential</strong>
						</div>	
						...
						<s:if test="#request.createCredential == 'yes'">
								...
								<s:if test="#request.credentialAlreadyCreated == 'yes'">
									...
									<font color="red"><strong>Crendential for this center has been already created!</strong></font>
									
								</s:if>
								
								<s:if test="#request.operationSuccuss == 'yes'">
								
									<font color="green"><strong>Crendential has been created successfully!</strong></font>
									
								</s:if>
								<s:elseif test="#request.createCenter == 'no'">
								
									<font color="red"><strong>Error while creating user's credentail, please contact site designer!</strong></font>
								</s:elseif>
								
								
								
								<form action="createUserCredential" method="POST" onSubmit="return changeOnlyPasswordMd5Hash();" autocomplete="off">
									...
									<div class="col-lg-12">
											...
											<div class="form-group text-left">
												...
												<div id="districtCodeId">
													<s:select list="refDistrictList" name="districtCodeId"
														...
														headerValue="---Select District---" listKey="districtCode" onchange="populateCenterForStateAndDistrict(this.value)"/>
												</div>
										...
										<div class="col-lg-4">
											<div class="form-group text-left">
												<label for="exampleInputName2"><span class="mandy">*</span>Centers</label>
												<div id="centerNameId">
													<s:select list="refCenterList" name="centerId"
														id="centerId" cssClass="form-control"
														listValue="name" headerKey="-1"
														headerValue="---Select Center---" listKey="id" />
												</div>
									...
									<div class="col-lg-12">
										...
										<div class="col-lg-4">
											<div class="form-group text-left">
												...
												<s:textfield name="centerUserEmailId" cssClass="form-control" placeholder="enter center's user email id" maxlength="100"></s:textfield>
											</div>
										</div>
										...
										<span class="mandy" id="invalidPassword"></span> 
											<div class="form-group text-left">
												...
												<s:password name="password" id="password" cssClass="form-control" placeholder="enter center's user password" maxlength="20"></s:password>
											</div>
										</div>
