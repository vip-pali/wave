...
<script type="text/javascript">
	...
	function changePassword(id,stateId,districtId){
		
		alert("id is: "+id);
		alert("state id is: "+stateId);
		alert("district id is: "+districtId);
		
		
		var action = 'changeCenterUserPassword?centerId=' + id+'&stateId='+stateId+'&districtCodeId='+districtId;
		
		document.getElementById('changePassword').action = action;		
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div id="content" class="col-lg-12 col-sm-12">
				...
				<div class="row">
					<div class="box col-md-12">
						...
						<s:if test="#request.viewCenter == 'yes'">
								
															
								<s:actionerror/>
								<s:if test="#request.isPasswordEdited == 'yes'">
								
									<font color="green"><strong>New password has been saved successfully!</strong></font>
									
								</s:if>
								<s:elseif test="#request.isPasswordEdited == 'no'">
								
									<font color="red"><strong>Error while saving new password, please contact site designer!</strong></font>
								</s:elseif>
								
								<form action="fetchCenterUserPassword" method="POST">
										...
										<div class="col-lg-4">
											<div class="form-group text-left">
												...
												<s:select list="refStateList" name="stateId" id="stateId"
													...
													headerValue="---Select States---" listKey="stateId"
											...
											<div class="form-group text-left">
												...
												<div id="districtCodeId">
													<s:select list="refDistrictList" name="districtCodeId"
														...
														headerValue="---All Districts---" listKey="districtCode" />
												</div>
				...
				<form method="post" action="" autocomplete="off" id="changePassword">		
							...
							<s:if test="#request.yesRecordExist == 'yesRecordExist'">
								<tr id="dirContent">
									<td align="left" colspan="0"><display:table
											...
											<display:column title="Change Password">											
												<img src='<s:url value="/images/edit.png"/>' style="cursor: pointer;" title="Change Password" onclick='javascript:changePassword("${attr.rowIndex.id}","${attr.rowIndex.stateId.stateId}","${attr.rowIndex.districtId.districtCode}")'/> 												
											</display:column>										
			...
			<s:if test="#request.enableChangePasswordPanel == 'yes">
			<s:form action="saveCenterUserPassword" method="post" onsubmit="changeOnlyPasswordMd5Hash();"></s:form>
			
									<div class="col-lg-12">

										<div class="col-lg-4">
											<div class="form-group text-left">
												<s:label>Center Code:<s:property value="centerId"/></s:label>
											</div>
										</div>
