...
<script type="text/javascript">
  ...
  function pageLoad(){
	  	...
	  	document.getElementById('totalCourseFees').value = '';
	...
	function validate(){	
		...
		//alert("Total amt is: "+totalfee);
		//alert("Amount received is: "+amtRec);
				...
				<div class="row">
					<div class="box col-md-12">
						...
						<br>		
							...
							<form action="saveStudentPaymentDetails" method="POST" autocomplete="off">
							 <s:hidden name="centerId" value="%{centerId}"></s:hidden> 
